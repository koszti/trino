...
public class FormUiClassicAuthenticatorModule
        implements Module
{
    private final boolean usePasswordManager;

    public FormUiClassicAuthenticatorModule(boolean usePasswordManager)
    {
    ...
    public void configure(Binder binder)
    {
        ...
        jaxrsBinder(binder).bind(LoginClassicResource.class);
