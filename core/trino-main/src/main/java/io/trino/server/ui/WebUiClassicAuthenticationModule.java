...
public class WebUiClassicAuthenticationModule
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        installWebUiAuthenticator("insecure", new FormUiClassicAuthenticatorModule(false));
        installWebUiAuthenticator("form", new FormUiClassicAuthenticatorModule(true));
        installWebUiAuthenticator("fixed", new FixedUiClassicAuthenticatorModule());
        installWebUiAuthenticator("oauth2", new OAuth2WebUiClassicModule());
    ...
    public static Module webUiAuthenticator(String name, Class<? extends Authenticator> clazz, Module module)
    {
        ...
        Module authModule = binder -> {
            binder.install(new FormUiClassicAuthenticatorModule(false));
